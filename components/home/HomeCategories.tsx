...
export const HomeCategories = ({className }:Props) => {
  ...
  return (
    <div className='bg-white border border-light-green/20 my-10 p-5 lg:p-7 rounded-md'>
        <Title className='border-b pb-3'>Popular Categories</Title>
        <div className='mt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3'>
          {[...Array(6)]?.map((cate,index)=>(

          <div key={`cat`+ cate+index} className='bg-light-bg p-4 flex  group items-center'>
