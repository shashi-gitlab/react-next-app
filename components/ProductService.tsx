    ...
    return (
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mt-14 p-2 py-5 shadow-xs'>
            <div className='flex items-center gap-3 group'>
                <TruckIcon className="w-10 h-10 text-pink group-hover:scale-105" />
            ...
            <div className='flex items-center gap-3 group'>
                <RotateCcw className="w-10 h-10 text-pink group-hover:scale-105" />
                <div className='text-sm'>
            ...
            <div className='flex items-center gap-3 group'>
                <Headphones className="w-10 h-10 text-pink group-hover:scale-105" />
                <div className='text-sm'>
            ...
            <div className='flex items-center gap-3 group'>
                <BadgeCheck className="w-10 h-10 text-pink group-hover:scale-105" />
                <div className='text-sm'>
